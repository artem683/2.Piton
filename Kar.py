...
e = input("введите True чтобы включить 1 рубильник:")
h = input("введите True чтобы Включить 2 рубильник:")
i = input("введите True чтобы Включить 3 рубильник:")
if e == "True" and h == "True" and i == "True":
    print ("Дверь открывается. Проходи, странник.")
else:
    print ("Ты выбрал неверно… Ловушка сработала!")
